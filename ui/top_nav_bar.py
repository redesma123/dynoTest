...
- Kiri  : Logo sistem.
- Tengah: Tab navigasi (aktif = latar accent-primary, tidak aktif = transparan).
- Kanan : Badge status koneksi PLC (CONNECTED/DISCONNECTED).

Status PLC di sini masih statis (DISCONNECTED) karena worker Modbus belum
dibangun di scope halaman Registrasi ini 
"""
...
# (key, label, shortcut) -- shortcut mengikuti docs/DESIGN_SYSTEM.md Bagian 6.
NAV_TABS = [
